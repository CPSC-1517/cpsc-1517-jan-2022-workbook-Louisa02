...
namespace PracticeConsole.Data
{
    public class Employment
    {
        ...
        // the following method will recieve a csv string of values
        //          that represents an instance of Employment
        // the method will
        ...
        public static Employment Parse(string text)
        {
            ...
            //step 1: seperate the string of values into individual values
            ...
            //step 3: retrun a new instance of the Employment class
        ...
        // the TryParse() method will recieve a string and output an instance of Employment via
        //     an output parameter
        // the method will return a boolean value indicating if the action within the method
        //     was successful
