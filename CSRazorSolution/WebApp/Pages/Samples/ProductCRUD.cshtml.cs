...
namespace WebApp.Pages.Samples
{
    public class ProductCRUDModel : PageModel
    {
        ...
        public IActionResult OnPostNew()
        {
            ...
            {
                //the try catch/error handling is used  to catch erro
                //  generated by the execution of the BLL service
                try
                {
                    //any BuildProperty will have the current control contents
                    //   in the property
            ...
            else
            {
                ...
                // (for select or group of radiobuttons, ect)
        ...
        public IActionResult OnPostUpdate()
        {
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    if(rowaffected > 0)
                    {
                        Feedback = $"Product id ({rowaffected}) has been updated on the system";
                    }
                    else
                    {
        ...
        {
            //dirll down to the REAL ERROR message
