...
namespace WestWindSystem.BLL
{
    public class ProductServices
    {
        ...
        //this row will be obtain by the pkey value of the row
        public Product Product_GetById(int productid)
        {
            ...
            //WHEN your retrieve variable (product) expects ONLY a SINGLE
            //  instance of the class (Product), you will 'tell' Linq
            //  return the 'first' instance found OR a 'default' value
        ...
        //  verification field.
        // Example: for this product insertion will verify
        ...
        //is the table pkey is NOT an identity then you MUST ensure
        // that the incoming instance of the row HAS a pkey value
        //If the table pkey is an identity then the database WILL 
        //  generate that value and make it accessable to you AFTER
        //  the data has been committed.

        //Product pkey is an identity attribute
        //This method optionally send the new identity value back to the
        ...
        {
            // for a delete, you MUST have the pkey value on your instance
            //if not, it will not work.
            ...
            // a) if you wish the record to be 'physically remove the database
            ...
            //      database IF there are existing 'childrenn' or the record
            ...
            // b) Logical delete
            //      this is where you do not or cannot physically remove a record from
            //      the database.
            //      this decision is based on exsiting best practice business rules OR 
            //      set by gov't regulations
